...
CREATE TABLE IF NOT EXISTS strategy_candidates (
  ...
  backtest_pnl DOUBLE NOT NULL DEFAULT 0.0,
  win_rate DOUBLE NOT NULL DEFAULT 0.0,
  avg_win DOUBLE NOT NULL DEFAULT 0.0,
  avg_loss DOUBLE NOT NULL DEFAULT 0.0,
  avg_win_loss_ratio DOUBLE NOT NULL DEFAULT 0.0,
  max_drawdown DOUBLE NOT NULL DEFAULT 0.0,
  trade_count INTEGER NOT NULL DEFAULT 0,
  stability_score DOUBLE NOT NULL DEFAULT 0.0,
  status VARCHAR NOT NULL DEFAULT 'NO_TRADE',
  created_at TIMESTAMPTZ NOT NULL,
...
CREATE TABLE IF NOT EXISTS final_session_plan (
  ...
  post_cost_pnl DOUBLE NOT NULL DEFAULT 0.0,
  win_rate DOUBLE NOT NULL,
  avg_win_loss DOUBLE NOT NULL,
  max_drawdown DOUBLE NOT NULL,
  market_regime VARCHAR NOT NULL DEFAULT 'BULLISH',
  sector_strength VARCHAR NOT NULL DEFAULT 'NEUTRAL',
  relative_strength DOUBLE NOT NULL DEFAULT 0.0,
  rvol DOUBLE NOT NULL DEFAULT 1.0,
  chase_status VARCHAR NOT NULL DEFAULT 'VALID',
