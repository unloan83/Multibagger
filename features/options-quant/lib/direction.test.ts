...
function broker(nifty = candles(25_000, 5), bank = candles(55_000, 11)): OptionsBroker {
  return {
    ...
    getOptionChain: async () => [{
      ...
      strike: 25_000,
      spot: 25_095,
      call: { instrumentKey: "c", tradingSymbol: "c", side: "BUY", optionType: "CE", strike: 25_000, bid: 100, ask: 101, ltp: 100.5, iv: 14, delta: 0.5, oi: 100_000, volume: 20_000, bidAskSpreadPercent: 1 },
      put: { instrumentKey: "p", tradingSymbol: "p", side: "BUY", optionType: "PE", strike: 25_000, bid: 90, ask: 91, ltp: 90.5, iv: 14, delta: -0.5, oi: 125_000, volume: 20_000, bidAskSpreadPercent: 1 },
    }],
