...
export function agentPerformance({
  ...
  const confidenceCalibration = completedHistory.length
    ...
    : null;
  const agents = ["existingLogic", "info", "macroPolicy", "sentiment", "portfolio", "riskValidation", "fundamental", "technical", "intraday", "swing", "longTerm", "earningsQuality", "rebalance"];
